...
if (sino === "si" || sino==="SI"|| sino==="Si"){
    ...
    let nombreUsuario =prompt("Perfecto, decime cual es tu nombre para que comencemos a calcular");

    alert("Ok "+nombreUsuario+" comencemos!!");

    alert("Primero debemos ingresar algunos datos para poder realizar los calulos");

    let monto = parseInt(prompt("sigamos, "+nombreUsuario+" ingrese el monto que desea solicitar: "));
...
else{alert ("ok, hasta la proxima   ")}
